# nvim-treesitter-queries-git_rebase

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-git_rebase/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-git_rebase/actions/workflows/validate.yml)

Neovim tree-sitter queries for **git_rebase**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-git_rebase",
...
- [ ] Changes are scoped to `git_rebase` — do not include files for other languages
